  ...
  return (
    <div className="pb-[120px]">
      ...
      <div className="w-fit relative">
        <h4 className=" text-[13px] xl:text-[13px] max:text-[28px] py-[15px] pl-[18px] pr-[70px] rounded-xl bg-[#F5F5F5] border border-[#C1C1C1] ">
      ...
      <div className="relative">
        <div className="xl:w-[625px] max:w-[1300px] w-full border border-[#C1C1C1] rounded-xl bg-[#9C1EFF0D]  mt-[60px] pl-[20px] py-[18px] pr-[15px] ">
          <p className="xl:text-[13px] max:text-[28px] text-[14px]  font-[400]  text-left">
          ...
          <h3 className="xl:text-[13px] max:text-[28px] text-[14px]  font-bold mt-[20px] text-left">
            PnL Summary (Today)
          </h3>
          <ul className="xl:text-[13px] max:text-[28px] text-[14px]  font-[400] mt-[5px] text-left list-disc ml-[14px]">
          ...
          <h3 className="xl:text-[13px] max:text-[28px] text-[14px]  font-bold mt-[7px] text-left">
            1. Arbitrage Win:
          </h3>
          <ul className="xl:text-[13px] max:text-[28px] text-[14px]  font-[400] mt-[5px] text-left list-disc ml-[25px]">
            <li>
              <b>Pair:</b> SOL/USDC
            </li>
            <li>
          ...
          <p className="xl:text-[13px] max:text-[28px] text-[14px]  font-[400] mt-[7px] text-left">
        ...
        <div className="absolute right-0 flex items-center gap-2 mt-[7px] xl:text-[13px] max:text-[20px] text-[12px] ">
      ...
      {/* lolchan reply */}
      <div className="relative">
        <div className="xl:w-[625px] max:w-[1300px]  w-full border border-[#C1C1C1] rounded-xl bg-[#0B8AFF0D]  mt-[60px] pl-[20px] py-[18px]  pr-[15px]">
          <p className="xl:text-[13px] max:text-[28px] text-[14px] font-[400]  text-left">
