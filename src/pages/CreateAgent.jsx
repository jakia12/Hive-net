  ...
  return (
    <>
      ...
      <div className="w-fit relative">
        <h4 className=" text-[13px] xl:text-[13px] 2xl:text-[21px] py-[13px] pl-[18px] pr-[70px] rounded-lg bg-[#F5F5F5] border border-[#C1C1C1] ">
          create new agent
        </h4>
      ...
      <div className="relative">
        <div className="xl:w-[625px] 2xl:w-[890px] w-full border-2 border-[#C1C1C1] rounded-xl bg-[#fff]  mt-[60px] pl-[20px] py-[18px] pr-[15px] ">
      ...
      <div className="relative">
        <div className="xl:w-[625px] 2xl:w-[890px] w-full border-2 border-[#C1C1C1] rounded-xl bg-[#fff]  mt-[60px] pl-[20px] py-[18px] pr-[15px] ">
          ...
          <h4 className="text-[13px] xl:text-[13px] 2xl:text-[21px] font-[400] mt-[6px] text-left">
            <b> 2. Choose a role 🛠️</b>
          </h4>
          <p className="text-[13px] xl:text-[13px] 2xl:text-[21px] font-[400] mt-[7px] text-left">
            What should your agent focus on?
          </p>
          <ul className="text-[13px] xl:text-[13px] 2xl:text-[21px] font-[400] mt-[5px] text-left list-disc ml-[25px]">
            <li>
