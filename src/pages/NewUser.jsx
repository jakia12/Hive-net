  ...
  return (
    <div className="pb-[120px]">
      ...
      <div className="w-fit relative">
        <h4 className=" text-[13px] xl:text-[13px] max:text-[28px]  py-[11px] pl-[20px] pr-[70px] rounded-lg bg-[#F5F5F5] border border-[#C1C1C1] ">
          Hello, what is this?
        </h4>
      ...
      <div className="relative">
        <div className="xl:w-[625px] max:w-[1300px]  w-full border-2 border-[#C1C1C1] rounded-xl bg-[#fff]  mt-[60px] pl-[20px] py-[15px] pr-[15px] ">
          ...
          <h4 className="text-[13px] xl:text-[13px] max:text-[28px] font-bold mt-[20px] text-left">
            To get started:
          </h4>
          ...
          <p className="text-[13px] xl:text-[13px] max:text-[28px] font-bold mt-[6px] text-left">
            {" "}
